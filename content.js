(function() {
  ...
  function getVisibleText(e) {
    ...
    var children = e.querySelectorAll(":scope > s");
  ...
  function hideIfSponsored(e) {
    ...
    var possibleSponsoredTags = e.querySelectorAll('div[id^="feed_sub_title"] span > s');
    possibleSponsoredTags.forEach(function(t) {
      if (getVisibleText(t).join("") === "Sponsored") {
        e.style.display = "none";
